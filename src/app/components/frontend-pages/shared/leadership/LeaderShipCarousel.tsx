      ...
      <Slider {...settings} className="leadership-carousel">
        <div style={slideStyle}>
          ...
          >
            ...
            <Typography variant="body1">Front-End Developer · 2022–Present</Typography>
          </UserBox>
        </div>
        <div style={slideStyle}>
          <Image
          ...
          >
            ...
            <Typography variant="body1">Full-time Front-End · 2018–2023</Typography>
          </UserBox>
        </div>
        <div style={slideStyle}>
          <Image
          ...
          >
            ...
            <Typography variant="body1">Web Developer · 2009–2016</Typography>
          </UserBox>
        </div>
        <div style={slideStyle}>
          <Image
          ...
          >
            ...
            <Typography variant="body1">Consultant · Remote</Typography>
          </UserBox>
        </div>
        <div style={slideStyle}>
          <Image
